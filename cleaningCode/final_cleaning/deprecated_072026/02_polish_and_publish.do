...
* ---> ADDED 'ccn' AND 'asc_id' TO ENSURE CLEAN MERGES LATER <---
...
forval i = 1/4 {
    ...
    if _rc == 0 {
        ...
        * 1. Drop Empty Variables (All Missing) using BASE STATA
        ...
        * 2. Optimize Numeric Storage (Double -> Float/Int where possible)
        compress
